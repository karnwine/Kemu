...
print(nfaParts[16].title)
print(nfaParts[16].maxThrust)
print(nfaParts[16].isp, end="\n\n")

print(nfaParts[17].title)
print(nfaParts[17].maxThrust)
print(nfaParts[17].isp, end="\n\n")
